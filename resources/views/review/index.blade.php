                                ...
                                <tbody>
                                    @foreach ($reviews as $review)
                                        <tr>
                                            ...
                                            <td>{{ $review->name }}</td>
                                            {{-- <td><img src="{{ asset($review->image) }}" width="75" alt="User Image"></td> --}}
                                            <td>{{ $review->text}}</td>
                                            <td>
                                                @if ($review->status == 1)
                                            ...
                                            <td>
                                                <form action="{{ route('reviews.destroy', $review->id) }}" method="POST" class="d-flex align-items-start justify-content-end">
